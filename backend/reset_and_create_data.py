#!/usr/bin/env python3
"""
Script xóa và tạo lại data mẫu trong MySQL
"""
...
def reset_database():
    ...
    try:
        ...
        db.execute(text("DELETE FROM syllabuses"))
        db.execute(text("DELETE FROM users"))
        db.commit()
        print("✅ Đã xóa toàn bộ data cũ")

    except Exception as e:
        print(f"❌ Lỗi khi xóa data: {e}")
        db.rollback()
    finally:
        db.close()
...
def create_sample_data():
    ...
    print("🚀 Tạo data mẫu mới trong MySQL database...")
